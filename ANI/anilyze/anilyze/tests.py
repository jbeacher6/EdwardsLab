...
class AnilyzeTest(unittest.TestCase):
  ...
  def testModifyLineLengthToSeventy(self):
    ...
    self.assertTrue(filecmp.cmp(str(os.getcwd()) + "/fnaFiles/correctlyFormatted/testModifyLineLengthToSeventy.fna", str(os.getcwd()) + "/correct/testModifyLineLengthToSeventy.fna", shallow=False))
